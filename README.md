...
This application is a Role-based school management web application, which is developed as a part of the Secure Web Development (Continuous Assessment) module.
